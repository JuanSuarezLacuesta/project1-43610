function purchase (movie) {
    for (let i = 0; i < selectionMovies.length; i++) { 
...
alert("Which premier you do you wish to attend?");

let trueTitle = "";
selectionMovies.forEach(element => {
    let title = element.title;
    trueTitle = trueTitle + title + ", ";
});


const premier1 = prompt (" These are the options: " + trueTitle);
